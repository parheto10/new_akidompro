...
function Analyse(){
    ...
    useEffect(()=>{
        ...
        {
            try {
                axios.get(baseUrl+'/campagnes-list/?userID='+user.id).then((resp)=>
                {
    ...
    const submitFormCampagne =()=>{
      ...
      if (campagneData.dateDebut !="" && campagneData.DateFin !=""){
          ...
          try {
            axios.post(baseUrl+'/create-new-campagne/',_formData).then((resp)=>{
              if(resp.data.bool)
              {
    ...
    return (
      <>
        ...
        <h2 className="text-bold text-1100 mb-5">Analyses</h2>
                    <div id="members" >
                      <div className="row align-items-center justify-content-between g-3 mb-4">
                        ...
                        <div className="col-auto">
                          <div className="d-flex align-items-center">
                              ...
                              <button className="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addEventModalCampagne">
                          ...
                          <table className="table table-striped table-sm fs--1 mb-0 ">
                            <thead>
                              <tr className="bg-warning">
                                <th className="sort align-middle" scope="col" data-sort="customer" style={{width:"20%"}}>Coopérative / Entité</th>
                                <th className="sort align-middle" scope="col" data-sort="email" style={{width:"20%"}}>Date</th>
              ...
              <div id="addEventForm" autoComplete="off">
                ...
                <div className="modal-body p-card py-0">
                  ...
                  <div className="modal-footer d-flex justify-content-between align-items-center border-0">
                    <button className="btn btn-primary px-4 form-control" type="button" onClick={submitFormCampagne}>Ajouter</button>
                  </div>
              </div>
            </div>
          </div>
